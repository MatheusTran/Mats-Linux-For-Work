...
# Screenshot Filename
source ~/.config/assets/settings/screenshot-filename.sh

# Screenshot Folder
source ~/.config/assets/settings/screenshot-folder.sh

# Screenshot Editor
export GRIMBLAST_EDITOR="$(cat ~/.config/assets/settings/screenshot-editor.sh)"
