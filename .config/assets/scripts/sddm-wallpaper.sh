...
sleep 1
clear
cache_file="$HOME/.config/assets/cache/current_wallpaper"
...
if [ -f $HOME/.config/assets/settings/sddm/theme.conf ]; then
    sddm_theme_tpl="$HOME/.config/assets/settings/sddm/theme.conf"
